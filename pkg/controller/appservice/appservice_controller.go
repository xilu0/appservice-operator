...
import (
	...
	appv1alpha1 "github.com/example-lnc/app-operator/pkg/apis/app/v1alpha1"
...
func (r *ReconcileAppService) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	dp := newDeploymentForCR(instance)

	// Set AppService instance as the owner and controller
	if err := controllerutil.SetControllerReference(instance, pod, r.scheme); err != nil {
		return reconcile.Result{}, err
	}
	if err := controllerutil.SetControllerReference(instance, dp, r.scheme); err != nil {
		return reconcile.Result{}, err
	}
	...
	reqLogger.Info("Skip reconcile: pod already exists", "Namespace", found.Namespace, "Name", found.Name)

	foundDp := &appsv1.Deployment{}
	err = r.client.Get(context.TODO(), types.NamespacedName{Name: dp.Name, Namespace: dp.Namespace}, foundDp)
	if err != nil && errors.IsNotFound(err){
		reqLogger.Info("creating a new Deployment", "Namespace:",dp.Namespace,"Name:",dp.Name)
	...
	reqLogger.Info("Skip reconcile: Deployment already exists", "Namespace", foundDp.Namespace, "Name", foundDp.Name)
	return reconcile.Result{}, nil
}
...
func newDeploymentForCR(cr *appv1alpha1.AppService) *appsv1.Deployment  {
	labels := map[string]string{
		"app": cr.Name,
	}
